...
@section('content')
    <div
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-4 sm:mb-0">Kelola Tagihan</h1>
    ...
    <div class="mb-6 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <form action="{{ route('admin.tagihan.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    {{-- <a href="{{ route('admin.tagihan.edit', $tagihan->id) }}" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 hover:bg-indigo-100 rounded-lg p-2 transition-colors">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-lg font-medium text-gray-900">Tidak ada data tagihan ditemukan.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
